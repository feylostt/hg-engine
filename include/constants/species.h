...
#define MAX_ALOLAN_REGIONAL_NUM (SPECIES_MAROWAK_ALOLAN) // 1143


//galarians
#define SPECIES_GALARIAN_REGIONAL_START (MAX_ALOLAN_REGIONAL_NUM + 1) // 1144
...
#define MAX_GALARIAN_REGIONAL_NUM (SPECIES_STUNFISK_GALARIAN) // 1162


//misc forms
#define SPECIES_MISC_FORM_START (MAX_GALARIAN_REGIONAL_NUM + 1) // 1163
...
#define MAX_MISC_FORM_NUM (SPECIES_ENAMORUS_THERIAN) // 1313

#define SPECIES_HISUIAN_REGIONAL_START (MAX_MISC_FORM_NUM + 1) // 1314
...
#define MAX_HISUIAN_REGIONAL_NUM (SPECIES_DECIDUEYE_HISUIAN) // 1329

#define SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_START (MAX_HISUIAN_REGIONAL_NUM + 1) // 1330
...
#define MAX_SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_NUM (SPECIES_BASCULEGION_FEMALE) // 1336

#define SPECIES_PALDEAN_FORMS_START (MAX_SPECIES_SIGNIFICANT_GENDER_DIFFERENCE_NUM + 1) // 1337
...
#define MAX_SPECIES_INCLUDING_FORMS (SPECIES_URSALUNA_BLOODMOON)  // 1363
